...
# ==========================================
# НАСТРОЙКИ ПРОЕКТА (измените под себя)
# ==========================================
...
# Удаляем старую сборку, если она была, и создаем чистые папки
rm -rf "$BUILD_DIR"
mkdir -p "$OUT_DIR"
mkdir -p "$DOC_DIR"

echo "========== 2. Поиск исходного кода =========="
# Находим все файлы .java и записываем их пути в текстовый файл.
# Это нужно, чтобы не перечислять десятки файлов вручную в терминале.
...
# Ключ -d указывает папку для готовых .class файлов
# Символ @ указывает javac прочитать список файлов из нашего текстового документа
...
# Важно: в конце файла манифеста обязательно должна быть пустая строка
echo "" >> "$MANIFEST"
